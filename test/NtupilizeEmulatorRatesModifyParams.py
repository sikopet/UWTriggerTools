...
options.outputFile = "NtupilizeEmulatorRatesModifyParams.root"
...
process.caloStage1Params.tauIsoLUTFile            = cms.FileInPath(options.tauIsoLUTFile)   #pre-RCT Calibration 0.1 Iso, 192 GeV Turn Off Tau Iso
